...
class JointSpacePlanner(SinglePlanner):
    ...
    def _plan_trajectory(
        ...
        try:
            ...
            raise ValueError(
                "Graph planner could not insert the start configuration into the roadmap. "
                "This usually means the start state is invalid for the current world "
                "(for example collision or disconnected graph seed)."
            ) from exc
